...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 19, 2023 lúc 02:48 PM
...
(3, 1, 'Iphone và Laptop', '<p>Decor thì đẹp lắm mà giá đắc quá. =((</p>', 'http://localhost/DO_AN_WEB/server/uploads/blog_imgs/cover_img_2.png', '2023-05-12 09:32:09', '2023-05-12 09:32:09'),
(4, 1, 'Đệ đệ song sinh với sư phụ Lâm Chánh Anh, Lâm Chánh Cửu', '<p>&Ocirc;ng n&agrave;y diễn cũng được nhưng kh&ocirc;ng bằng &ocirc;ng sư huynh, Cũm OK lắm.</p>', 'http://localhost/DO_AN_WEB/server/uploads/blog_imgs/64622300327bd__screenshot_1683480102.png', '2023-05-12 09:34:43', '2023-05-15 07:18:08'),
...
(1, 1, 'Nguyễn', 'Vũ', 'Nguyễn Vũ', '@7V', '2002-05-04', '0358802875', 'http://localhost/DO_AN_WEB/server/images/admin.png', 'http://localhost/DO_AN_WEB/server/images/admin_cover-img.png', 0, 0, 'https://www.facebook.com/nguyenvu.version2319.vn', '', '', ''),
(2, 3, '', 'Thanh Tú', 'Thanh Tú', '@thanhtu', '0000-00-00', '', 'http://localhost/DO_AN_WEB/server/uploads/user_imgs/avatar/z4358586127130_3ec0bfbe7c227cc72e97b3ae09231bd6.jpg', 'http://localhost/DO_AN_WEB/server/images/no-image-cover.png', 0, 0, '', '', '', ''),
(3, 4, '', 'Thảo Vy', 'Thảo Vy', '@thaovy', '0000-00-00', '', 'http://localhost/DO_AN_WEB/server/uploads/user_imgs/avatar/z4315931380514_a7101470ff1a4f37ae34e2167e385029.jpg', 'http://localhost/DO_AN_WEB/server/images/no-image-cover.png', 0, 0, '', '', '', '');
